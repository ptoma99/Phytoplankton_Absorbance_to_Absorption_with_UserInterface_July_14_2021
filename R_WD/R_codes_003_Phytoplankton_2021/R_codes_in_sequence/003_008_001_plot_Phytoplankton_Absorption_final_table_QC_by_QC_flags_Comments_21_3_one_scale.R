#001_008_plot_Phytoplankton_Absorption_final_table_QC_by_QC_flags_Comments_21_3_one_scale
...
dir.create(file.path("C:/R_WD/WRITE/WORKS_PLOT_Phytoplankton_Absorption_by_QC_flags_Comments"), showWarnings = FALSE, recursive = TRUE)
...
for (i in 1:nrow(all_tables_joined_by_folder_name)){
  ...
  project_folder_name <- all_tables_joined_by_folder_name$folder_name[i]
  filepath_to_write_plot <- paste0("C:/R_WD/WRITE/WORKS_PLOT_Phytoplankton_Absorption_by_QC_flags_Comments/RESULTS/", project_folder_name, "/")
  ...
  for (j in 1:nrow(Absorption_Phytoplankton_file)){
    ...
    if (Absorption_Phytoplankton_file$QC_flag_410_smaller_than_440[j] == 0 && Absorption_Phytoplankton_file$QC_flag_443_to_490[j] == 0 && Absorption_Phytoplankton_file$QC_flag_ChlA_to_443_550_670[j] == 0){   
      ...
      plot(Wavelength_nm, y_Phytoplankton, xlab = "Wavelength (nm)", ylab = "Absorption", ylim = c(min_Absorption, max_Absorption), type = "l", col = "black", lwd=2, sub = paste0(project_folder_name, " - ",all_tables_joined_by_folder_name$coded_cruise_name[i]," - " ,"Pkytoplankton Absorption by QC flags - Sample ID = " , d6_string))
    ...
    plot(Wavelength_nm, y_Phytoplankton, xlab = "Wavelength (nm)", ylab = "Absorption", ylim = c(min_Absorption, max_Absorption), type = "l", col = "green", lwd=2, sub = paste0(project_folder_name, " - ",all_tables_joined_by_folder_name$coded_cruise_name[i]," - " ,"Pkytoplankton Absorption by QC flags - Sample ID = " , d6_string))
    legend("topright", legend=c("green 111 - 410nm < 440nm passed, 443_to_490 passed, ChlA_to_443_550_670 passed", "value seems correct ", paste0("Comments: ", Absorption_Phytoplankton_file$Comments[j])),
      ...
      plot(Wavelength_nm, y_Phytoplankton, xlab = "Wavelength (nm)", ylab = "Absorption", ylim = c(min_Absorption, max_Absorption), type = "l", col = "blue", lwd=2, sub = paste0(project_folder_name, " - ",all_tables_joined_by_folder_name$coded_cruise_name[i]," - " ,"Pkytoplankton Absorption by QC flags - Sample ID = " , d6_string))
      ...
      plot(Wavelength_nm, y_Phytoplankton, xlab = "Wavelength (nm)", ylab = "Absorption", ylim = c(min_Absorption, max_Absorption), type = "l", col = "red", lwd=2, sub = paste0(project_folder_name, " - ",all_tables_joined_by_folder_name$coded_cruise_name[i]," - " ,"Pkytoplankton Absorption by QC flags - Sample ID = " , d6_string))
      ...
      plot(Wavelength_nm, y_Phytoplankton, xlab = "Wavelength (nm)", ylab = "Absorption", ylim = c(min_Absorption, max_Absorption), type = "l", col = "orange", lwd=2, sub = paste0(project_folder_name, " - ",all_tables_joined_by_folder_name$coded_cruise_name[i]," - " ,"Pkytoplankton Absorption by QC flags - Sample ID = " , d6_string))
      ...
      plot(Wavelength_nm, y_Phytoplankton, xlab = "Wavelength (nm)", ylab = "Absorption", ylim = c(min_Absorption, max_Absorption), type = "l", col = "purple", lwd=2, sub = paste0(project_folder_name, " - ",all_tables_joined_by_folder_name$coded_cruise_name[i]," - " ,"Pkytoplankton Absorption by QC flag 0123 - Sample ID = " , d6_string))
...
rgl::legend3d("topleft", legend = c(paste('Phytoplankton Absorption by QC_flags'), paste(c(project_folder_name)), paste(all_tables_joined_by_folder_name$coded_cruise_name[i]," - ", length(1:nrow(Absorption_Phytoplankton_file)), " Sample ID's" ), paste(' '),
           ...
           pch = 16, col = c("white", "white", "white", "white", "black", "white", "green", "green", "green", "green", "green", "white", "blue", "blue", "blue", "blue", "white", "orange", "orange", "orange", "orange", "white", "purple", "purple", "purple", "purple", "white", "red", "red", "red", "red"), cex=1, inset=c(0.02))#, box.lty = 0)
  ...
  dir.create(file.path(paste0("C:/R_WD/WRITE/WORKS_PLOT_Phytoplankton_Absorption_by_QC_flags_Comments/RESULTS/1_index_png/")), showWarnings = FALSE, recursive = TRUE)
  rgl::rgl.snapshot(paste0("C:/R_WD/WRITE/WORKS_PLOT_Phytoplankton_Absorption_by_QC_flags_Comments/RESULTS/1_index_png/", project_folder_name, "_", all_tables_joined_by_folder_name$coded_cruise_name[i], "_Phytoplankton_Absorption_by_QC_Comments_", length(1:nrow(Absorption_Phytoplankton_file)), "_SampleIDs.png"))
